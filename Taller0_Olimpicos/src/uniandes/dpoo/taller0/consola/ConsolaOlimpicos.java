...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pais al que representa un atleta por su nombre");
	}
	 ...
	 * Ejecuta la opción para consultar los atletas de un año.
	 */
	private void ejecutarconsultaPaisAtleta()
	{

		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		String nombrepais = calculadora.atletapaisconsulta(nombre_atleta);
		System.out.println("El pais al cual representa el atleta buscado es: " + nombrepais);
